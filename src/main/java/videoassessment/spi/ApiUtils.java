...
public class ApiUtils {
  ...
  public static final ImmutableList<String> QUESTIONS = ImmutableList.<String>builder()
      .add("Explain the issues properly based on the audience’s background<->Neglect the audience’s level of expertise and use a lot of jargon")
      .add("Show a deep understanding of the audience’s concerns<->Neglect the audience’s viewpoints")
      .add("Focus on satisfying the audience’s decision criteria<->My topic, my rules")
      .add("Test multiple options against their decision criteria<->Assume what is best for them without proofs")
      .add("Use data to support conclusions<->Lack of data")
      .add("Speak clearly and with verve<->Speak quietly with little emotion or energy")
      .add("Paint a vivid picture<->The audience need a lot of brainwork to get what you are trying to say")
      .add("Interject relevant stories and analogies<->Rely solely on data")
      .add("Frame your ideas to engage aspirations<->Describe things in neutral or negative terms")
      .add("Structure ideas visually<->Only smart people can follow the logic")
      .add("Consistently maintain your composure<->Get nervous, defensive or irritable at times")
      .add("Look at everyone and smile warmly<->Rarely make eye contact or smile")
      .add("Exude confidence with body and voice<->Slouch, rarely gesture, hedge or hesitate")
      .add("Speak fluently with proper speed<->Speak too quickly or use a lot filler words")
      .add("Show respect and openness when interacting with audience<->Show impatience or correct others when asked questions")
      .build();
